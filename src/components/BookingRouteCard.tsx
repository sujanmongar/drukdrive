      ...
      <div className="mt-4 flex items-start gap-3 border-t border-[color:var(--color-border)] pt-4">
        ...
        <div className="flex flex-1 flex-col gap-5 text-sm">
          ...
          <div>
            ...
            <p className="font-semibold text-[#222]">{dropoff}</p>
          </div>
        </div>
      </div>
    </div>
