...
export default function ContactCard() {
  return (
    <div className="rounded-2xl border border-[color:var(--color-border)] bg-white p-5 shadow-card">
      ...
      <p className="mt-3 text-center t-body font-semibold tabular text-[color:var(--color-ink)]">{PHONE}</p>
      <dl className="mt-4 flex flex-col gap-1.5 border-t border-[color:var(--color-border)] pt-4 t-caption">
        <div className="flex items-center justify-between gap-3">
          <dt>Email</dt>
          <dd>
            <a href="mailto:support@drukdrive.bt" className="font-semibold text-[color:var(--color-ink)] hover:underline">
        ...
        <div className="flex items-center justify-between gap-3">
          <dt>Hours</dt>
          <dd className="font-semibold text-[color:var(--color-ink)]">7:00–22:00, every day</dd>
        </div>
      </dl>
    </div>
  );
