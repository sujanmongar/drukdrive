...
export default function RouteGuard({ role, children }: { role?: Role; children: ReactNode }) {
  ...
  if (role && currentRole !== role) {
    return <Navigate to={currentRole === "driver" ? routes.providerBookings : routes.home} replace />;
  }
