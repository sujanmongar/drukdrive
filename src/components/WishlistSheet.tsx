      ...
      <div className="animate-sheet-up relative flex max-h-[80svh] w-full flex-col overflow-hidden rounded-t-2xl bg-white">
              ...
              {saved.map((vehicle) => {
                ...
                return (
                  ...
                  >
                    ...
                    >
                      <p className="t-body truncate font-bold text-[color:var(--color-ink)]">
                        {vehicle.name}
                      </p>
        ...
        <div className="shrink-0 border-t border-[color:var(--color-border)] p-4 pb-[max(1rem,env(safe-area-inset-bottom))]">
          <Link
            ...
            onClick={onClose}
            className="block w-full rounded-xl border border-[color:var(--color-ink)] py-3 text-center t-body-sm font-bold text-[color:var(--color-ink)] hover:bg-[color:var(--color-surface-soft)]"
          >
            View all
          </Link>
        </div>
