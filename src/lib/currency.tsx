...
export const currencies: { code: CurrencyCode; symbol: string; flag: string; rateFromUsd: number }[] = [
  { code: "BTN", symbol: "Nu.", flag: "🇧🇹", rateFromUsd: 83 },
  { code: "USD", symbol: "$", flag: "🇺🇸", rateFromUsd: 1 },
  { code: "INR", symbol: "₹", flag: "🇮🇳", rateFromUsd: 83 },
];
