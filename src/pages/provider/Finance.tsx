...
const summaryCards = [
  { key: "totalEarnings", label: "Total Earnings", icon: "wallet" as const },
  { key: "pending", label: "Pending Payout", icon: "clock" as const },
  { key: "withdrawn", label: "Withdrawn", icon: "check-circle" as const },
];
    ...
    <PageShell>
      ...
      <div className="mx-auto max-w-[1440px] px-4 py-8 md:px-[60px] md:py-10">
        ...
        <p className="mt-1 text-sm text-[color:var(--color-muted)]">
          Track what you've earned and your payout history.
        </p>
        ...
        <div className="mt-8 flex flex-wrap items-center justify-between gap-3">
          ...
          <button
            type="button"
            className="rounded-xl bg-[#222] px-4 py-2.5 text-sm font-semibold text-white hover:bg-black"
          >
            Withdraw earnings
          </button>
        </div>
